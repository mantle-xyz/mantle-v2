...
mod tests {
    ...
    // [MANTLE] `address!` / `b256!` are still used by the Mantle BVM_ETH tests further down,
    // so they stay in the import set alongside upstream's additions.
    ...
    fn bare_deposit_body_is_rejected() {
        let canonical = TxDeposit {
            ...
            input: Bytes::new(),
            // [MANTLE] BVM_ETH fields added to upstream's new literal.
            eth_value: U256::ZERO,
            eth_tx_value: None,
        }
        .encoded_2718();
    ...
    fn eip2718_deposit_decode() {
        ...
        let original = TxDeposit {
            ...
            input: Bytes::from_static(&hex!(
                ""
            )),
            eth_tx_value: None,
        };
