...
// is seconds, not blocks). With 6s L1 blocks that is L1 block amsterdamOffset/6 = block 10,
// leaving pre-Amsterdam blocks 1-9 — room to fund the depositors under the auto-FakePoS and
// still land a deposit in a block BEFORE the activation block.
