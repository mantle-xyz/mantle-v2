...
// subprocess so the sequencer and verifier both derive a genuine Glamsterdam L1. It
// auto-locates a mise-installed geth (mirroring the fusaka suite) so these tests are
// self-sufficient and do NOT require SYSGO_GETH_EXEC_PATH to be exported by the runner.
// No-op if DevstackL1ELKindEnvVar or GethExecPathEnvVar is already set.
