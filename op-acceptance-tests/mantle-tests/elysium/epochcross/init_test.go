...
// amsterdamOffset activates Amsterdam SECONDS after L1 genesis. It is chosen so that with 6s L1
// blocks the activation lands on L1 block 32 — an L1 (beacon) epoch boundary (32 slots): 32*6=192.
