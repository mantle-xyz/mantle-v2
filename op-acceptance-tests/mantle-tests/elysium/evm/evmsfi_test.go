...
//
// 8037 note: unlike the others, Mantle op-geth has no compiled-in branch for it (neither
// AccountCreationSize nor CostPerStateByte defined), so this sub-case is a regression guard
// against 8037 ARRIVING via a rebase rather than a check on an already-gated behavior.
