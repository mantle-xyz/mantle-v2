...
// amsterdamOffset activates Amsterdam on the L1 a few blocks after genesis, so the submission
// retry paths below are exercised against a genuinely post-Glamsterdam L1.
