...
// amsterdamOffset activates Amsterdam a few L1 blocks after genesis (offset unit is SECONDS),
// leaving a pre-Amsterdam runway so the sequencer's L1 origin genuinely crosses the boundary.
