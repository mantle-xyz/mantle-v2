...
// amsterdamOffset activates Amsterdam on the L1 a few seconds after genesis
// (WithForkAtL1Offset takes a time offset in SECONDS, not blocks), so the L1
// crosses into Glamsterdam very early and spends the rest of its life
// finalizing genuinely post-Amsterdam blocks.
